...
// Muestra quién se encarga: avatar de GitHub + avatar de Slack (si hay) y el nombre.
    ...
    <div className="flex items-center gap-1.5">
      <div className="flex -space-x-1.5">
        ...
        <img
          ...
          alt={`${nombre} (GitHub)`}
          title={`${nombre} · GitHub`}
          className="h-6 w-6 rounded-full border-2 border-white bg-[var(--color-surface-soft)]"
        />
